...
const uint16_t PROGMEM ni_combo[] = {LSFT_T(KC_N), LALT_T(KC_I), COMBO_END};
const uint16_t PROGMEM rt_combo[] = {LSFT_T(KC_T), LALT_T(KC_R), COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
	...
	COMBO(lu_combo, KC_K),	// TODO: find some use?
	COMBO(ni_combo, KC_K),
	COMBO(rt_combo, KC_V),
};
